            ...
            request(options, (error, resp, body) => {
                ...
                if (error) {
                    ...
                    try{
                        ...
                        cookie = cookie.filter((item)=>{
                            return !item.startsWith('MYSAPSSO2=')
                        })
                        response.headers['Set-Cookie'] = JSON.stringify(cookie)
                        //response.headers['sap-cookie'] = JSON.stringify(cookie)
